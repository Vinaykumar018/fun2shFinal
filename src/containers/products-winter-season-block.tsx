...
const ProductsWinterSeasonBlock: React.FC<ProductsProps> = ({
  sectionHeading = 'text-winter-season',
            ...
            <>
              {variant === 'default' ? (
                ...
                <Carousel
                  ...
                  prevActivateId="winterSeasonSlidePrev"
                  nextActivateId="winterSeasonSlideNext"
                >
                  {products?.map((product: Product) => (
...
export default ProductsWinterSeasonBlock;
